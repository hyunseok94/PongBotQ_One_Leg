...
void Load(void) {
    ...
    Addons::URDFReadFromFile("/home/rclab/catkin_ws/src/RcLab-PongBot_V1/model/PONGBOT_Q_V6/urdf/PONGBOT_Q_V6.urdf", pongbot_q_model, true, false);
...
void DataSave(void) {
    save_array[save_cnt][0] = check_motion_time;
    save_array[save_cnt][1] = motion_time;

...
int main(int argc, char *argv[]) {
    ...
    //pthread_create(&p_thread3, NULL, ros_task, NULL);
...
void DataSave(void) {
    ...
    save_array[save_cnt][5] = CTC_Torque[0];
    save_array[save_cnt][6] = CTC_Torque[1];
    save_array[save_cnt][7] = CTC_Torque[2];
